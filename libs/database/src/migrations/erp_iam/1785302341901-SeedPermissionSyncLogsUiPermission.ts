...
/**
 * Adds the `page:view_permission_sync_logs` UI-plane permission gating the
 * new Permission Sync Logs admin page (sidebar nav item + `bootAdminPage({
...
const NEW_UI_PERMISSIONS: Array<[string, string, string, string, string]> = [
  [
    ...
    'เข้าหน้าประวัติการซิงค์สิทธิ์',
    'View permission sync logs page',
  ],
];
...
export class SeedPermissionSyncLogsUiPermission1785302341901
  implements MigrationInterface
{
  name = 'SeedPermissionSyncLogsUiPermission1785302341901';
