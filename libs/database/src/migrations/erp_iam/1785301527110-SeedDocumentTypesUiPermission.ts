...
/**
 * Adds the `page:view_document_types` UI-plane permission gating the new
 * Document Types admin page (sidebar nav item + `bootAdminPage({
 ...
 * `SeedPrintTemplatesUiPermission1785291692317`.
 */
const NEW_UI_PERMISSIONS: Array<[string, string, string, string, string]> = [
  [
    'page:view_document_types',
    'page_document_types',
    'view_document_types',
    'เข้าหน้าประเภทเอกสาร',
    'View document types page',
  ],
];
...
export class SeedDocumentTypesUiPermission1785301527110
  implements MigrationInterface
{
  name = 'SeedDocumentTypesUiPermission1785301527110';
