/**
 * Swagger/Scalar documentation strings for `RolesController`.
 */

export const CREATE_ROLE_SUMMARY = 'Create role';
export const GET_ROLES_SUMMARY = 'List roles';
export const GET_ROLE_SUMMARY = 'Get role by id';
