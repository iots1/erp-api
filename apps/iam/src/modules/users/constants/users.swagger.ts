/**
 * Swagger/Scalar documentation strings for `UsersController`.
 */

export const CREATE_USER_SUMMARY = 'Create user account';
export const GET_USERS_SUMMARY = 'List user accounts';
export const GET_USER_SUMMARY = 'Get user account by id';
